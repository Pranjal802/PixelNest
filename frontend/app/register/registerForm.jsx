...
//     try {
//         console.log("In try catch block before api call");
//         const res = await axios.post(base_url+"/auth/client-register",clientData);
//         // console.log("In try catch block after api call");
...
//           onClick={() => {
//             setRole("admin");
//             setAcceptedTerms(false); // reset when switching
//           }}
//           className={`flex-1 py-2 rounded-full text-sm font-medium transition ${
